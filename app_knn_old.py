...
def init():
    ...
    if not os.path.exists(map_path):
        ...
        sys.exit(1)
    # 1. Init Model
    print("[Init] Loading OLD Cosine KNN (K=5) from project(2)")
...
def api_locate():
    ...
    STATE["filter_info"] = "Old Cosine KNN K=5 + EMA Smoothing"
